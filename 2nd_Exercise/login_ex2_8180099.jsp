...
<html lang="en">
  <head>
		...
		<meta name="description" content="2η Ατομική Άσκηση - login page">
		<title>2η Ατομική Άσκηση - Sign in</title>
  ...
  <body>
    ...
    <div class="container" role="main">
		...
		<form class="form-signin" method="post" action="<%=request.getContextPath() %>/loginController_ex2_8180099.jsp">
