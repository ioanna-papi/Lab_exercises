...
<head>
	...
	<meta name="description" content="registerController">
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li><a href="index_ex2_8180099.jsp">Home</a></li>            
            <li class="active"><a href="register_ex2_8180099.jsp">Register</a></li>
	    <li><a href="about_ex2_8180099.jsp">About</a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </nav>
...
if (name1.length()>2 && surname1.length()>2 && username1.length()>4 && password1.length()>4 && password1.equals(confirm1)&& notification!=null){
	...
	User user = new User(name1, surname1, email1, username1, password1);
	try {
...
<h3>Registration form has errors</h3>
			...
			<a class="btn btn-primary" href="register_ex2_8180099.jsp" role="button"> < Back to the form</a>
</div>
<%} %>     		
